      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
              icon: Icon(Icons.art_track), title: Text(ArtUtil.CARAVAGGIO)),
          BottomNavigationBarItem(
              icon: Icon(Icons.art_track), title: Text(ArtUtil.MONET)),
          BottomNavigationBarItem(
              icon: Icon(Icons.art_track), title: Text(ArtUtil.VANGOGH))
        ],
        onTap: (value) {
